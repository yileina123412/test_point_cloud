...
if(global_point_mapping_CONFIG_INCLUDED)
  return()
endif()
set(global_point_mapping_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(global_point_mapping_SOURCE_PREFIX /home/furina/cloud_test_project/test_point_cloud/src/global_point_mapping)
  set(global_point_mapping_DEVEL_PREFIX /home/furina/cloud_test_project/test_point_cloud/devel)
  set(global_point_mapping_INSTALL_PREFIX "")
  set(global_point_mapping_PREFIX ${global_point_mapping_DEVEL_PREFIX})
else()
  set(global_point_mapping_SOURCE_PREFIX "")
  set(global_point_mapping_DEVEL_PREFIX "")
  set(global_point_mapping_INSTALL_PREFIX /home/furina/cloud_test_project/test_point_cloud/install)
  set(global_point_mapping_PREFIX ${global_point_mapping_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'global_point_mapping' is deprecated")
...
set(global_point_mapping_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/furina/cloud_test_project/test_point_cloud/src/global_point_mapping/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(global_point_mapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/furina/cloud_test_project/test_point_cloud/src/global_point_mapping/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND global_point_mapping_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/furina/cloud_test_project/test_point_cloud/devel/lib;/home/furina/cloud_test_project/test_point_cloud/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(global_point_mapping_LIBRARY_DIRS ${lib_path})
      list(APPEND global_point_mapping_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'global_point_mapping'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND global_point_mapping_LIBRARIES ${lib})
    endif()
  endif()
...
set(global_point_mapping_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${global_point_mapping_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "pcl_conversions;pcl_ros;roscpp;sensor_msgs;std_msgs;tf")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 global_point_mapping_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${global_point_mapping_dep}_FOUND)
      find_package(${global_point_mapping_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${global_point_mapping_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(global_point_mapping_INCLUDE_DIRS ${${global_point_mapping_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(global_point_mapping_LIBRARIES ${global_point_mapping_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${global_point_mapping_dep}_LIBRARIES})
  _list_append_deduplicate(global_point_mapping_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(global_point_mapping_LIBRARIES ${global_point_mapping_LIBRARIES})

  _list_append_unique(global_point_mapping_LIBRARY_DIRS ${${global_point_mapping_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(global_point_mapping_EXPORTED_TARGETS ${${global_point_mapping_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${global_point_mapping_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
