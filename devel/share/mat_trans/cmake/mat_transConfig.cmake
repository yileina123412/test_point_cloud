...
if(mat_trans_CONFIG_INCLUDED)
  return()
endif()
set(mat_trans_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(mat_trans_SOURCE_PREFIX /home/furina/cloud_test_project/test_point_cloud/src/mat_trans)
  set(mat_trans_DEVEL_PREFIX /home/furina/cloud_test_project/test_point_cloud/devel)
  set(mat_trans_INSTALL_PREFIX "")
  set(mat_trans_PREFIX ${mat_trans_DEVEL_PREFIX})
else()
  set(mat_trans_SOURCE_PREFIX "")
  set(mat_trans_DEVEL_PREFIX "")
  set(mat_trans_INSTALL_PREFIX /home/furina/cloud_test_project/test_point_cloud/install)
  set(mat_trans_PREFIX ${mat_trans_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'mat_trans' is deprecated")
...
set(mat_trans_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/furina/cloud_test_project/test_point_cloud/src/mat_trans/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/local/include " STREQUAL " ")
  set(mat_trans_INCLUDE_DIRS "")
  set(_include_dirs "/home/furina/cloud_test_project/test_point_cloud/src/mat_trans/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/local/include")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND mat_trans_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(mat_trans_LIBRARY_DIRS ${lib_path})
      list(APPEND mat_trans_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'mat_trans'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND mat_trans_LIBRARIES ${lib})
    endif()
  endif()
...
set(mat_trans_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${mat_trans_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;std_msgs;sensor_msgs;pcl_ros;pcl_conversions")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 mat_trans_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${mat_trans_dep}_FOUND)
      find_package(${mat_trans_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mat_trans_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(mat_trans_INCLUDE_DIRS ${${mat_trans_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(mat_trans_LIBRARIES ${mat_trans_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${mat_trans_dep}_LIBRARIES})
  _list_append_deduplicate(mat_trans_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(mat_trans_LIBRARIES ${mat_trans_LIBRARIES})

  _list_append_unique(mat_trans_LIBRARY_DIRS ${${mat_trans_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(mat_trans_EXPORTED_TARGETS ${${mat_trans_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${mat_trans_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
