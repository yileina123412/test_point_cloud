...
if(pca_test_CONFIG_INCLUDED)
  return()
endif()
set(pca_test_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(pca_test_SOURCE_PREFIX /home/furina/cloud_test_project/test_point_cloud/src/pca_test)
  set(pca_test_DEVEL_PREFIX /home/furina/cloud_test_project/test_point_cloud/devel)
  set(pca_test_INSTALL_PREFIX "")
  set(pca_test_PREFIX ${pca_test_DEVEL_PREFIX})
else()
  set(pca_test_SOURCE_PREFIX "")
  set(pca_test_DEVEL_PREFIX "")
  set(pca_test_INSTALL_PREFIX /home/furina/cloud_test_project/test_point_cloud/install)
  set(pca_test_PREFIX ${pca_test_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'pca_test' is deprecated")
...
set(pca_test_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/furina/cloud_test_project/test_point_cloud/src/pca_test/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/local/include " STREQUAL " ")
  set(pca_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/furina/cloud_test_project/test_point_cloud/src/pca_test/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/local/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${pca_test_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pca_test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pca_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/furina/cloud_test_project/test_point_cloud/src/pca_test/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pca_test_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND pca_test_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND pca_test_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT pca_test_NUM_DUMMY_TARGETS)
      set(pca_test_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pca_test::wrapped-linker-option${pca_test_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pca_test_NUM_DUMMY_TARGETS "${pca_test_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pca_test::wrapped-linker-option${pca_test_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pca_test_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(pca_test_LIBRARY_DIRS ${lib_path})
      list(APPEND pca_test_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'pca_test'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND pca_test_LIBRARIES ${lib})
    endif()
  endif()
...
set(pca_test_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${pca_test_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 pca_test_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${pca_test_dep}_FOUND)
      find_package(${pca_test_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pca_test_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(pca_test_INCLUDE_DIRS ${${pca_test_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(pca_test_LIBRARIES ${pca_test_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${pca_test_dep}_LIBRARIES})
  _list_append_deduplicate(pca_test_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(pca_test_LIBRARIES ${pca_test_LIBRARIES})

  _list_append_unique(pca_test_LIBRARY_DIRS ${${pca_test_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(pca_test_EXPORTED_TARGETS ${${pca_test_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${pca_test_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
